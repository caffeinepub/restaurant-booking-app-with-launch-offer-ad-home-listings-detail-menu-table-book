...
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: bigint, arg1: string, arg2: Time, arg3: bigint): Promise<bigint> {
    ...
    async getRestaurantDetails(arg0: bigint): Promise<Restaurant | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getRestaurantDetails(arg0);
